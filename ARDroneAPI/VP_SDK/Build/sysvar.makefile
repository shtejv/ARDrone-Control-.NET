...
ifeq ($(USE_NDS),yes)
    ...
    ifeq ($(USE_MINGW32),yes)
      ...
      ifeq ($(USE_ELINUX),yes)
        ...
        ifeq ($(TOOLCHAIN_VERSION),arm-2006q3)
...
TARGET_IDS:=OS APP DLL LIB SDK COM CODEC JPEG BONJOUR PARROTOS_CORE PARROTOS_UTILS PARROTOS_DRIVERS PARROTOS_DEVS PARROTOS_CODEC LIBPLF ARDRONE_VISION ARDRONE_POLARIS ARDRONE_TEST_BENCHS ARDRONE_CALIBRATION ARDRONELIB
